    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs p-4 overflow-y-auto">
            <form onSubmit={handleSubmit} className="bg-white flex flex-col w-full max-w-lg p-8 shadow-2xl rounded-2xl relative my-auto border border-gray-100">
                ...
                <h1 className="text-2xl font-extrabold text-gray-800 text-center mb-6">Uredi gosta</h1>
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-600 mb-1.5">Napomene / Alergije</label>
                        <textarea 
                            name="notes"
                            ...
                            className="w-full p-4 bg-white border border-gray-200 overflow-x-hidden rounded-xl focus:ring-2 focus:ring-[#B8926A]/20 focus:border-[#B8926A] text-gray-700 placeholder-gray-400 outline-hidden transition resize-none"
                        ></textarea>
                    </div>
                </div>
